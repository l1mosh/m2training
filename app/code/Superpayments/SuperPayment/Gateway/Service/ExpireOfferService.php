...
class ExpireOfferService implements ApiServiceInterface
{
    ...
    public function execute(array $subject): DataObject
    {
        ...
        if (!isset($subject['cashback_offer_id'])) {
            throw new InvalidArgumentException('cashback_offer_id should be provided');
        }
        ...
        try {
            ...
            throw new ApiServiceException(__('SuperPayments error on expire cashback offer. Please try again later.'));
        }
